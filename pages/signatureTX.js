...
*/
  ...
  return (
    <>
      ...
      <Wallet name={'Émetteur'} />

      <Wallet name={'Récepteur'} />
      ...
      <Grid.Container gap={2}>
        <Grid xs={4} justify='flex-end'><Text h3>Message</Text></Grid><Grid  xs={8}>
          <Textarea width='32em'  rows='4'  bordered initialValue="6:joe=>gaston"  ref={messageRef} onChange={onChangeMessage } /></Grid>      
          <Grid xs={4} justify='flex-end'><Text h3>Clef privée</Text></Grid><Grid  xs={8}><Input ref={clefPriveRef} width="32em" onChange={onChangeMessage } /></Grid>    
      ...
      <Grid.Container gap={2}>
          <Grid xs={4} justify='flex-end'><Text h3>Message</Text></Grid><Grid  xs={8}><Textarea width='32em'  rows='4'  bordered initialValue="6:joe=>gaston"  ref={messageVerifRef} onChange={onChangeVerif } /></Grid>      
          <Grid xs={4} justify='flex-end'><Text h3>Clef publique</Text></Grid><Grid  xs={8}><Textarea ref={clePulicVerifRef} width="32em" onChange={onChangeVerif } /></Grid>
